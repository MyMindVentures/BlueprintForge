...
const TOUR_TARGET_IDS: Record<typeof TOUR_STEP_DEFS[number], string> = {
  startFresh: "btn-new-project",
  defineIdea: "raw-concept-input",
  chooseSpecialist: "agent-selector",
  magicHappens: "btn-convert",
  browseStructure: "structured-cards-panel",
  exportReady: "markdown-preview-panel",
  configureIntelligence: "btn-llm-settings"
};
...
export function Onboarding() {
  ...
  const tourSteps: TourStep[] = TOUR_STEP_DEFS.map((key) => ({
    targetId: TOUR_TARGET_IDS[key],
    title: t(`demo.tour.${key}.title`),
    content: t(`demo.tour.${key}.content`)
  }));
  const welcomeSteps = [
    t("demo.welcome.stepCreateOpenProject"),
    t("demo.welcome.stepPasteConcept"),
    t("demo.welcome.stepConvertCards")
  ];
        ...
        {showWelcome && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <h2 className="text-3xl font-black text-white mb-4 tracking-tight">{t("demo.welcome.title")}</h2>
        ...
        >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              >
                {isLast ? t("buttons.finish") : t("buttons.next")} <ChevronRight size={14} />
              </button>
            </div>
          </div>
        </motion.div>
